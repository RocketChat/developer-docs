...
Get a list of canned responses. It supports the [Offset, Count, and Sort Query Parameters](../../team-collaboration-endpoints/others/offset-and-count-and-sort-info.md).
