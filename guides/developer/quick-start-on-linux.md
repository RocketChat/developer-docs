...
Using Windows to develop is not recommended at this time, instead is better to create a Linux virtual machine and follow the steps mentioned above, but if for some reason you really need to build Rocket.Chat on Windows you can find a community supported guide over [here](developing-on-windows-10.md).
...
* [Supporting SSL for Mobile Apps](mobile-apps/supporting-ssl-for-development-on-rocket.chat.md)
* [Development Troubleshooting](troubleshooting.md)
* [Deployment Methods](quick-start-on-linux.md)
