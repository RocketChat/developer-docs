...
You can find a list of issues [here](https://github.com/RocketChat/docs/issues). When you find something you would like to work on just comment your interest and we will add an **In Progress** label.
...
* [Using your personal Gitbook space.](./#using-a-gitbook-workspace)
* [Directly from your local environment](./#local-environment-setup).

### Using a Gitbook workspace
...
* [New Feature Template](broken-reference)
* [Feature Change Template](broken-reference)
