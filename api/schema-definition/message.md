...
* `attachments`: _\(Optional\)_ A collection of [attachment objects](../rest-api/endpoints/team-collaboration/chat/postmessage.md#attachments-detail), available only when the message has at least one attachment
...
[The attachment object is fully described here](../rest-api/endpoints/team-collaboration/chat/postmessage.md#attachments-detail)
